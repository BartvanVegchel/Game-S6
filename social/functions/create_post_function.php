...
<?php if ($_SERVER["REQUEST_METHOD"] == "POST") { // Controleer of het formulier verzonden is
        ...
        header("Refresh: 3; url=../add_post.php");
            echo "<div class='container'><div class='alert alert-danger'><strong><span class=\"entypo-block\"></span>You have to fill in all fields</h2>" . "<p>You haven't filled in all the fields. Please give us enough information to create this post.</p></div></div>";
    }
